...
El servicio FTP fue incluido para facilitar la **gestión remota de archivos multimedia**, especialmente en etapas de prueba y administración del contenido. Se eligió por su simplicidad, amplia compatibilidad con herramientas cliente (como FileZilla) y facilidad de configuración.
