...
La estructuración de los racks en los Centros de Procesamiento de Datos  ha sido diseñada para garantizar un rendimiento óptimo, alta disponibilidad y escalabilidad. Cada CPD, ubicado en Zaragoza, Bilbao y Santiago de Compostela, cuenta con una configuración específica de racks adaptada a sus funciones principales, cumpliendo con estándares internacionales como ANSI/TIA-942 e ISO/IEC 27001, y alineándose con los Objetivos de Desarrollo Sostenible (ODS) 7 (energía asequible y no contaminante), 9 (industria, innovación e infraestructura) y 12 (producción y consumo responsables). La infraestructura de racks combina servidores de alto rendimiento, almacenamiento robusto, redes redundantes y sistemas de gestión energética avanzados, optimizando la eficiencia y asegurando la continuidad operativa mediante replicación activa y respaldos pasivos. Este diseño refleja el compromiso de InnovateTech con una infraestructura tecnológica confiable, sostenible y preparada para el futuro.


El CPD principal en Zaragoza, que sirve como el núcleo de la infraestructura crítica, aloja seis racks de 42U estándar, diseñados para gestionar el sitio web, bases de datos, backups, almacenamiento centralizado y la integración híbrida con Amazon Web Services (AWS). Cada rack está equipado con seis servidores blade, cada uno con procesadores duales Intel Xeon, 512 GB de RAM y almacenamiento SSD/NVMe, proporcionando la potencia necesaria para aplicaciones de alto rendimiento. Además, se incluyen dos servidores de base de datos configurados en alta disponibilidad, con replicación interna y externa para garantizar la integridad de los datos. Un servidor dedicado de autenticación, basado en protocolos LDAP/RADIUS, opera con redundancia para gestionar el acceso seguro de los usuarios. La monitorización se realiza mediante un servidor equipado con herramientas como SNMP, Prometheus y Grafana, que ofrecen visibilidad en tiempo real del rendimiento y alertas proactivas. Para el almacenamiento, cada rack cuenta con un NAS rackeable TrueNAS Enterprise, configurado con diez discos de 14 TB en RAID Z2, un disco hot spare y dos SSD NVMe para caché, con replicación activa hacia el CPD de Bilbao. La conectividad está asegurada por dos switches core redundantes (10/40/100 Gbps, Cisco Nexus) y dos switches de acceso (48 puertos, 10 Gbps), complementados por dos firewalls redundantes con sistemas IPS/IDS integrados. Cada rack incluye una PDU inteligente para monitorización energética por dispositivo y un SAI de alta eficiencia de 6 kVA, con una autonomía mínima de 30 minutos, garantizando continuidad en caso de cortes eléctricos. La refrigeración se basa en un sistema de pasillo frío/caliente con sensores térmicos que ajustan automáticamente el flujo de aire, manteniendo las condiciones óptimas para los equipos.


El CPD secundario en Bilbao, enfocado en redundancia, respaldo activo, balanceo de carga y recuperación ante desastres, aloja cuatro racks de 42U. Estos racks están configurados para complementar las operaciones de Zaragoza, asegurando una continuidad fluida en escenarios de alta demanda o fallos. Cada rack incluye cuatro servidores blade con especificaciones similares a las de Zaragoza, garantizando consistencia en el rendimiento. Dos servidores de base de datos replicados desde Zaragoza mantienen la sincronización de datos críticos, mientras que un servidor de monitorización y respaldo, junto con un servidor de autenticación secundaria, refuerzan la disponibilidad. Un servidor dedicado a backups incrementales optimiza la protección de datos. El almacenamiento se gestiona mediante un NAS rackeable TrueNAS idéntico al de Zaragoza, aunque con un número reducido de discos (ocho de 14 TB) para priorizar eficiencia, configurado para replicación bidireccional y exportación vía iSCSI. La red está soportada por dos switches core y dos switches de acceso redundantes, junto con dos firewalls redundantes, asegurando una conectividad robusta de 10 Gbps por servidor. Cada rack cuenta con una PDU inteligente y un SAI de 6 kVA con autonomía de 30 minutos, optimizados para cumplir con normativas de sostenibilidad. La refrigeración, basada en un sistema de pasillo frío/caliente, utiliza sensores térmicos para un control adaptativo, aprovechando el clima favorable de Bilbao para minimizar el consumo energético.


El CPD de respaldo pasivo en Santiago de Compostela, diseñado para backups remotos, recuperación ante fallos mayores y almacenamiento en frío, aloja dos racks de 42U. Estos racks están optimizados para un bajo consumo energético, con una configuración más ligera que prioriza la eficiencia. Cada rack incluye dos servidores multiuso, mantenidos en modo espera o apagados para una activación rápida en caso de emergencia, junto con un servidor dedicado a backups incrementales. El almacenamiento se gestiona mediante una unidad NAS de almacenamiento en frío, equipada con cuatro discos de 14 TB en RAID Z1, diseñada para minimizar el consumo energético mientras asegura la capacidad de recuperación. La conectividad se soporta mediante un switch básico con redundancia mínima, suficiente para las operaciones pasivas. Cada rack cuenta con un SAI eficiente de 4 kVA, con una autonomía de 15 minutos, y un sistema de refrigeración optimizado para bajo consumo, basado en pasillos frío/caliente con control adaptativo. Esta configuración asegura que el CPD de Santiago funcione como un respaldo fiable sin incurrir en un consumo energético innecesario.
...
Esta estructuración de racks proporciona una infraestructura tecnológica robusta, escalable y eficiente, diseñada para cumplir con las demandas operativas de InnovateTech. La combinación de servidores de alto rendimiento, almacenamiento redundante, redes resilientes y sistemas de gestión energética avanzados asegura un entorno confiable y preparado para el crecimiento futuro, manteniendo el enfoque en la sostenibilidad y el cumplimiento de estándares globales.


![i10](img1/rack_zaragoza.png)

![i11](img1/rack_bilbao.png)
...
El sistema de protección contra incendios está concebido con una arquitectura especializada que prioriza la detección temprana y la respuesta automática, cumpliendo con estándares como ISO/IEC 27001, EN 50600 y NFPA 2001. Su diseño permite mitigar eficazmente riesgos sin comprometer la operatividad ni la sostenibilidad.

La detección se basa en sensores láser de alta sensibilidad tipo VESDA, capaces de identificar partículas de humo en fases muy tempranas. Estos dispositivos se ubican en zonas críticas, permitiendo generar alertas proactivas que se integran con las herramientas de monitorización de infraestructura para una rápida actuación.
