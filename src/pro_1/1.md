...
ODS 7 (Energía asequible y no contaminante), ODS 9 (Industria, innovación e infraestructura), ODS 12 (Producción y consumo responsables), ODS 13 (Acción por el clima) y ODS 16 (Paz, justicia e instituciones sólidas).

Cada decisión técnica, desde la climatización hasta el cableado estructurado, responde a un compromiso firme con los Objetivos de Desarrollo Sostenible (ODS) y las normativas ambientales más exigentes. Esta sección detalla cómo se materializa ese compromiso en la infraestructura crítica desplegada en Zaragoza, Bilbao y Santiago de Compostela, posicionando a InnovateTech como referente en centros de datos sostenibles.

#### **Optimización energética y cálculo de huella de carbono**

El diseño de la infraestructura busca optimizar el consumo energético mediante la implementación de tecnologías de alta eficiencia y estrategias de operación inteligente. La arquitectura actual incluye instancias cloud en AWS (región eu-west-3) con una configuración estándar de 8 vCPU, 32 GB RAM y 500 GB de almacenamiento por máquina virtual, operando en promedio 18 horas al día.

Considerando un consumo estimado de 0,2 kWh/hora por instancia, cada una consume 3,6 kWh diarios, lo que equivale a unas 1,08 kg CO₂ eq/día, aplicando el factor de conversión medio de 0,3 kg CO₂/kWh (referencia: Carbon Trust, AWS Carbon Calculator).

Adicionalmente, los servicios de red (monitorización, backups y posibles tareas de streaming o análisis de datos) generan un tráfico diario estimado de 120 GB, con un consumo asociado de aproximadamente 0,6 kWh/día, asumiendo un valor medio de 5 Wh/GB transferido. Sumando ambos factores, el consumo energético digital diario por CPD asciende a 4,2 kWh, lo que representa aproximadamente 1,26 kg CO₂ eq/día.

Estas métricas permiten cuantificar el impacto ambiental y establecer objetivos claros de reducción, a través de estrategias como: limitar el tiempo de operación ininterrumpida, implementar apagado automático en horas valle, migrar a arquitecturas serverless, o seleccionar regiones cloud que operen exclusivamente con energía renovable.
...
La incorporación de fuentes de energía limpia es una prioridad para reducir la dependencia de combustibles fósiles. En los tres CPD se garantiza que al menos el 80% de la electricidad consumida provenga de fuentes renovables certificadas, según la Directiva Europea 2018/2001. En Zaragoza, este compromiso se refuerza con la instalación de paneles solares de 200 kW en la cubierta, que alimentan iluminación, sensores IoT y otros sistemas auxiliares.

Por su parte, el CPD de Bilbao se beneficia del acceso directo a energía eólica regional, mientras que Santiago de Compostela adopta un diseño pasivo, operando en modo de bajo consumo y priorizando tareas de respaldo, siempre con alimentación de origen renovable. Los generadores diésel, utilizados únicamente como respaldo en emergencias, cumplen con la normativa Euro Stage V de bajas emisiones, y se evita su uso prolongado gracias a SAIs con baterías de litio y AGM de alta eficiencia.

La plataforma EcoStruxure, en conjunto con Prometheus y Grafana, permite monitorizar la proporción de energía renovable utilizada, generando informes para auditorías ambientales conforme a la norma ISO 14001, fortaleciendo la transparencia institucional y alineándose con los principios del ODS 16.

![o2](img1/chuttersnap-IfmqOuOkaOA-unsplash-1024x684.jpg)

#### **Diseño responsable del cableado e infraestructura física**

La reducción de la longitud del cableado estructurado es una medida clave para mejorar la eficiencia energética y reducir el uso de materiales. En Zaragoza, los 6 racks cuentan con switches de acceso de 48 puertos / 10 Gbps montados en la parte superior, lo que reduce las conexiones internas a menos de 2 metros.
...
Se ha priorizado el uso de materiales de baja atenuación y alta durabilidad, certificados bajo TIA/EIA-568-B, asegurando una transmisión óptima y reduciendo el número de retransmisiones, lo cual se traduce en un menor consumo energético indirecto.

Además, el diseño físico se complementa con sensores IoT que permiten medir la temperatura, humedad y calidad del aire en tiempo real, garantizando que los sistemas HVAC operen únicamente cuando sea necesario, optimizando su eficiencia mediante el sistema de *free cooling* y ventiladores de velocidad variable.

![o3](img1/caracteristicas-de-cableado-horizontal-de-red.jpg)

#### **Monitorización ambiental y control inteligente**

Todo el ecosistema está gestionado mediante una plataforma de monitorización centralizada que combina **EcoStruxure**, **Prometheus** y **Grafana**, generando *dashboards* e informes automáticos sobre indicadores clave: consumo energético, uso de energía renovable, eficiencia del cableado, y desviaciones en el **PUE (Power Usage Effectiveness)**. Actualmente, se mantiene un PUE promedio de **1.2 - 1.3**, gracias a decisiones estratégicas en el diseño y operación.
...
Estos reportes no solo garantizan transparencia y trazabilidad, sino que permiten la mejora continua, alineando la operación diaria con los principios de sostenibilidad, responsabilidad ambiental y justicia institucional.

![o3](img1/ia-medio-ambiente.jpg)

#### **Gestión de residuos y economía circular**

La sostenibilidad no termina en la operación diaria, sino que se extiende a la gestión del final de vida de los activos tecnológicos. **Innovate Tech** ha implementado políticas activas de reciclaje y tratamiento seguro de residuos eléctricos y electrónicos (**RAEE**), en colaboración con entidades certificadas. Las baterías agotadas, equipos obsoletos y materiales de cableado retirado son tratados bajo procedimientos de **economía circular**, donde se prioriza la recuperación de componentes reutilizables y la minimización del desecho no reciclable.

Estas medidas están respaldadas por programas internos de formación y sensibilización que promueven un uso responsable de los recursos, asegurando que el personal —desde técnicos hasta responsables de área— entienda su rol dentro del ecosistema sostenible, fomentando una cultura organizativa participativa y responsable en línea con los valores del ODS 16.

Además, todos los proveedores de equipamiento e infraestructura están sujetos a criterios de contratación ética y cumplimiento normativo, promoviendo relaciones institucionales justas y responsables en toda la cadena de valor.

---

Este enfoque integral contribuye no solo a reducir el impacto ambiental de la infraestructura, sino también a consolidar una cultura organizativa comprometida con la sostenibilidad, la justicia, la transparencia y la responsabilidad institucional.
