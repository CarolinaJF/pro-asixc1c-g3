...
<!-- ✅ Com optimitzar el consum d’energia --> <!-- ✅ Parada d’equips de comunicacions quan no hi ha càrrega --> <!-- ✅ Equips de baix consum energètic -->
...
La plataforma EcoStruxure, en conjunto con Prometheus y Grafana, permite monitorizar la proporción de energía renovable utilizada, generando informes para auditorías ambientales conforme a la norma ISO 14001.
...
Los accesos a estos informes se realizan a través de autenticación multifactor (**MFA**) con **Azure AD**, cumpliendo con las políticas de seguridad y las exigencias normativas. Estos reportes no solo garantizan transparencia y trazabilidad, sino que permiten la mejora continua, alineando la operación diaria con los principios de sostenibilidad y responsabilidad ambiental.
...
Estas medidas están respaldadas por programas internos de formación y sensibilización que promueven un uso responsable de los recursos, asegurando que el personal —desde técnicos hasta responsables de área— entienda su rol dentro del ecosistema sostenible. Este enfoque contribuye no solo a reducir el impacto ambiental de la infraestructura, sino también a consolidar una cultura organizativa comprometida con la sostenibilidad.
