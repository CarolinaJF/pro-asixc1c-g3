...
| idPK       | codigo_catFK | id_dptFK | nom       | apellidos           | direccion                                                  | telefono     | puesto                                                                                  |
|------------|--------------|----------|-----------|----------------------|-------------------------------------------------------------|--------------|-----------------------------------------------------------------------------------------|
...
| nomenclatura | grupo_nivel | salario     | periodo_prueba | vacaciones |
|--------------|-------------|-------------|----------------|------------|
...
## Implementación de la base de datos en postgres: 
